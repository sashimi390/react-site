  ...
  return (
    <header className="hero is-small is-success is-bold">
      <div className="hero-body">
        ...
        <p className="subtitle">日本のコロナ状況</p>
      </div>
    </header>
  );
}
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="control is-expanded ">
            <div className="select  is-link ">
              <select name="breed" defaultValue="北海道">
                {datas.map((data) => {
                  return <option value={data.name_ja}>{data.name_ja}</option>;
                })}
        ...
        <div className="control">
          <button
            type="submit"
            className="button is-link is-focused is-rounded"
          >
            Reload
          </button>
        </div>
...
function Main() {
  ...
  const [death_datas, deathDatas] = useState(null);
  ...
  useEffect(() => {
    ...
    getData2().then((datas) => {
      datas.sort((x, y) => y.deaths - x.deaths);
      deathDatas(datas);
    });
  }, []);
      ...
      <section className="section">
        <div className="container">
          <div className="columns">
            ...
            <div className="column" size="assign">
              <a
                class="twitter-timeline"
                data-height="100%"
                data-theme="light"
                href="https://twitter.com/nhk_news?ref_src=twsrc%5Etfw"
              >
                Tweets by nhk_news
              </a>{" "}
              <script
                ...
                charset="utf-8"
              ></script>
              <TwitterTweetEmbed tweetId={"nhk_news"} />
            </div>
          </div>
        </div>
      </section>
  ...
  return (
    <footer className="footer">
      <div className="content has-text-centered">
        <p> From COVID-19</p>
        <p>
          <a href="https://covid19-japan-web-api.vercel.app/api/v1/prefectures">
            When will the corona problem settle down?
          </a>
        </p>
      </div>
    </footer>
